...
class Name(Expr):
    ...
    def eval(self, env):
        ...
        if self.string in env:
            ...
            raise NameError(self.string + ' not found')
...
class CallExpr(Expr):
    ...
    def eval(self, env):
        ...
        for operand in self.operands:
            evaluated_operands.append(operand.eval(env))
        ...
        ''' The hint: all operands/operators have eval methods'''
        ''' Use the apply function: taking in a list of arguments'''
